...
train_imagefolder = dataloader.PairImageFolder('/datasets/CycleGan/horse2zebra',
                                              train_transforms,
                                              mode='train')
...
def load(netG_A2B, netG_B2A, netD_A, netD_B, optimizer_G, optimizer_D):
    print('Loading...', end=' ')
    checkpoint = torch.load('/kuacc/users/ebostanci18/comp411/AttentionGan-SelfAttention/checkpoint/horse2zebra/ckpt.pth')
    ...
    for i, data in enumerate(train_loader, 0):                  
        ...
        if i % 1000 == 0:
            with torch.no_grad():
                ...
                print()
                save('horse2zebra/ckpt.pth', netG_A2B, netG_B2A, netD_A, netD_B, optimizer_G, optimizer_D, current_epoch)
