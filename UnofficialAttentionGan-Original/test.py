...
val_imagefolder = dataloader.PairImageFolder('/datasets/CycleGan/summer2winter_yosemite',
                                              val_transforms,
                                              mode='test')
...
def load(netG_A2B, netG_B2A, netD_A, netD_B, optimizer_G, optimizer_D):
    print('Loading...', end=' ')
    checkpoint = torch.load('/kuacc/users/ebostanci18/comp411/AttentionGan-SelfAttention/checkpoint/summer2winter/ckpt.pth')
...
def save_example(tensor_list, size, image_iter, image_count):
    ...
    plt.savefig(f'/kuacc/users/ebostanci18/comp411/AttentionGan-SelfAttention/results/summer2winter/i{image_iter}-{image_count}.png', bbox_inches='tight')
