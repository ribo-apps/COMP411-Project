...
val_imagefolder = dataloader.PairImageFolder('/datasets/CycleGan/horse2zebra',
                                              val_transforms,
                                              mode='test')
...
def save_example(tensor_list, size, image_iter, image_count):
    ...
    plt.savefig(f'/kuacc/users/ebostanci18/comp411/AttentionGan-SelfAttention/results/horse2zebra/i{image_iter}-{image_count}.png', bbox_inches='tight')
