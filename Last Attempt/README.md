If you want to get the model checkpoints or have questions, e-mail: brizai18@ku.edu.tr

Check the script.sh for training and script_test.sh for testing scripts we have used.

python train.py --dataroot datasets --model attention_gan --gpu_ids -1
