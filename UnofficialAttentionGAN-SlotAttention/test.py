...
#val_imagefolder = val_imagefolder[:3]
print("Done!")
...
def save_example(tensor_list, size, image_iter, image_count):
    ...
    plt.savefig(f'/kuacc/users/ebostanci18/comp411/AttentionGAN/results/summer2winter/i{image_iter}-{image_count}.png', bbox_inches='tight')
