...
def load(netG_A2B, netG_B2A, netD_A, netD_B, optimizer_G, optimizer_D):
    print('Loading...', end=' ')
    checkpoint = torch.load('/kuacc/users/ebostanci18/comp411/AttentionGAN/checkpoint/horse2zebra/ckpt.pth')
...
def save_example(tensor_list, size, image_iter, image_count):
    ...
    plt.savefig(f'/kuacc/users/ebostanci18/comp411/AttentionGAN/results/horse2zebra/i{image_iter}-{image_count}.png', bbox_inches='tight')
